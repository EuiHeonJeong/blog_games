...
| 비행 슈팅 | [`games/shooting`](games/shooting) | 도시부터 외계행성까지 이어지는 7스테이지 세로 슈팅. 스테이지별로 다른 보스/적기/배경, 아이템 7종(무기·폭탄·보호막·레이저·스피드·사이드건·1UP), 죽어도 10초 안에 이어하기, 1인/2인 협동(터치·마우스 드래그 + 키보드 지원) |
